...
#ifndef SURFACETOOLS_FEATUREBSPLINESURF_H
#define SURFACETOOLS_FEATUREBSPLINESURF_H
...
class SurfaceToolsExport BSplineSurf :  public Part::Feature
{
    PROPERTY_HEADER(SurfaceTools::BSplineSurf);
